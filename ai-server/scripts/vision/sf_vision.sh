...
load_profile() {
  ...
  export AI_SERVER_VENV_DIR="${AI_SERVER_VENV_DIR:-${ROOT_DIR}/.venv}"
...
Processes selected by profile:
  ...
  gateway_auth: ${SF_VISION_GATEWAY_HMAC_MODE} (credential managed internally; value hidden)
...
SF_VISION_GATEWAY_HMAC_MODE=${SF_VISION_GATEWAY_HMAC_MODE}
