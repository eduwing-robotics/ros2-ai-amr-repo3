...
#
# Usage:
#   SLOT=a bash scripts/scenarios/field/run_center_slot_l2_lift_test.sh
#   PRE_INSERT_MM=50 UNLOAD_MM=12 SLOT=b bash scripts/scenarios/field/run_center_slot_l2_lift_test.sh
#
set -euo pipefail
