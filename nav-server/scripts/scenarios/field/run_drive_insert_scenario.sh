...
#
# Usage:
#   SCENARIO=in1_b_wait2 bash scripts/scenarios/field/run_drive_insert_scenario.sh
#   SCENARIO=all bash scripts/scenarios/field/run_drive_insert_scenario.sh
#   LOOPS=3 SCENARIO=in2_b_wait2 bash scripts/scenarios/field/run_drive_insert_scenario.sh
#
# Scenarios:
...
run_in1_c_wait2() {
  visit_wall_slot "in1" "-0.085" "0.006" "1.571" "0" "0.40" "0.22"
  visit_center_slot "c" "1.226" "-0.025" "3.142" "10" "0.395" "0.10"
  park_wait2 "wait2"
}
...
run_out2_a_wait2() {
  ...
  visit_center_slot "a" "0.026" "-0.025" "0.0" "7" "0.385" "0.10"
  park_wait2 "wait2"
}
