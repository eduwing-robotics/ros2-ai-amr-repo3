...
- Mapping, graph, route, and layout tools: `draw_current_layout_review.py`, `draw_layout_map.py`, `draw_map_review.py`, `draw_zone_mask.py`, `generate_center_wall_waypoints.py`, `generate_factory_grid_waypoints.py`, `record_waypoint_pose.py`.
