...
The two GET endpoints are intentionally public, read-only diagnostics. Every
lock mutation requires the Main HMAC/replay boundary.
"""
...
@router.post("/traffic/lock", dependencies=[Depends(require_main_signature)])
...
@router.post("/traffic/release", dependencies=[Depends(require_main_signature)])
...
@router.post("/zones/lock", dependencies=[Depends(require_main_signature)])
...
@router.post("/zones/release", dependencies=[Depends(require_main_signature)])
