...
이 모듈은 zones.json에 정의된 구역과 Waypoint를 바탕으로
...
from nav_app.services.aruco_detector_activation import activation_requested, set_activation
...
def main():
    ...
    # 인자 처리
    if len(sys.argv) < 2:
        print("사용법: python3 -m nav_app.services.logistics_navigator <waypoint_name>")
        print("       python3 -m nav_app.services.logistics_navigator --list")
