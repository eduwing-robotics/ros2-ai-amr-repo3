...
def map_identity(*, map_id: str, yaml_digest: str | None, image_digest: str | None, resolution, origin, width, height) -> str | None:
    if not yaml_digest or not image_digest or resolution is None or origin is None or width is None or height is None:
        return None
    material = {
