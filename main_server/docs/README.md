...
공개 문서는 아래 10개가 전부다. 상세 설계 노트·의사결정 기록(ADR)·팀 정책 문서는 팀 내부에서 관리한다.
...
| 10 | [MOVEMENT_SERVER_REQUIREMENTS](MOVEMENT_SERVER_REQUIREMENTS.md) | Movement 팀 전달용 명령·콜백·실시간 안전 요구 |
## 독자별 읽기 순서
