...
INSERT INTO commands (task_type, sequence_no, command_type, target_system, required_evidence_type, request_template_json, timeout_sec, is_active) VALUES
    ...
    ('INBOUND',  3, 'move_to_point',  'movement', 'ARRIVED', '{"kind":"move_to_point","target":"storage_scan"}'::jsonb, 120, true),
    ('INBOUND',  4, 'dock_transfer',  'movement', 'DONE',    '{"kind":"dock_transfer","mode":"storage_unload"}'::jsonb, 180, true),
    ('INBOUND',  5, 'move_to_point',  'movement', 'ARRIVED', '{"kind":"move_to_point","target":"home"}'::jsonb, 120, true),
    ...
    ('OUTBOUND', 3, 'move_to_point',  'movement', 'ARRIVED', '{"kind":"move_to_point","target":"outbound_scan"}'::jsonb, 120, true),
    ('OUTBOUND', 4, 'dock_transfer',  'movement', 'DONE',    '{"kind":"dock_transfer","mode":"outbound_unload"}'::jsonb, 180, true),
    ('OUTBOUND', 5, 'move_to_point',  'movement', 'ARRIVED', '{"kind":"move_to_point","target":"home"}'::jsonb, 120, true),
