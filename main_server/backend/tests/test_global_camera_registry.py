# 기능 책임: 전역·로봇 카메라 source registry와 stream proxy을 검증한다. 비책임: 실장비의 물리 동작.
"""global_cam_01 camera registry tests."""
...
from app.domains.vision.sources_router import list_camera_sources
...
class GlobalCameraRegistryTest(unittest.TestCase):
    ...
    @patch("app.domains.vision.router.fetch_stream_transports")
    ...
    @patch("app.domains.vision.router.open_mjpeg_stream")
    ...
    @patch("app.domains.vision.router.post_webrtc_offer")
