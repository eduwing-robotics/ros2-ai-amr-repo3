...
def main() -> int:
    ...
    parser.add_argument("--map-yaml", default="/home/lucas/slam_nav_ws/map/robot1_map.yaml")
    parser.add_argument("--graph", default="/home/lucas/slam_nav_ws/map/agv_waypoint_graph.yaml")
    ...
    grid = load_map_yaml(Path(args.map_yaml), unknown_is_blocked=args.unknown_is_blocked)
    graph = load_corridor_graph(Path(args.graph))
    ...
    print(
        f"map={args.map_yaml} graph={args.graph} "
