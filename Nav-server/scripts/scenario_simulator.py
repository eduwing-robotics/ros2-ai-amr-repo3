...
def main():
    ...
    try:
        while True:
            ...
            if choice == '1': sim.send_battery(15)
            elif choice == '2': sim.send_battery(100)
            elif choice == '3': sim.send_obstacle('static')
            elif choice == '4': sim.send_obstacle('dynamic')
            elif choice == '5': sim.send_obstacle('none')
            elif choice == '6': sim.send_estop(True)
            elif choice == '7': sim.send_estop(False)
            elif choice == 'q': break
