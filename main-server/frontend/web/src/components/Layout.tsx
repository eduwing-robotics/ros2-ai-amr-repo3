...
export function Layout() {
  ...
  const movementBadge = movementDryRun ? "warn" : movementOnline ? "ok" : "off";
  ...
  const cameraBadge = cameraOnline ? "ok" : "off";
    ...
    <div className="shell" data-mode={mode.key}>
      <header className="header chrome">
        ...
        <div className="header-right">
          ...
          <div className={`livestat${liveOk ? "" : " err"}`} title={liveOk ? robotTitle : "서버 응답 없음"}>
