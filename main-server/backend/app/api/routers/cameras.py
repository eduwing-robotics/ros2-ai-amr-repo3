...
@router.post("/camera-sources", response_model=ApiMessage, dependencies=[Depends(require_admin)])
...
@router.delete("/camera-sources/{source_id}", response_model=ApiMessage, dependencies=[Depends(require_admin)])
