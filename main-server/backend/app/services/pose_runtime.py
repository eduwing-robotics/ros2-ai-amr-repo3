    ...
    def ingest(
        ...
        *,
        ...
        with self._lock:
            ...
            active_map_id = str(self._map_context.get("active_map_id") or "")
            if active_map_id and map_id != active_map_id:
                raise ValueError(
                    f"pose map_id mismatch: expected {active_map_id}, got {map_id}"
                )
