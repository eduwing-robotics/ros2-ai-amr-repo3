...
INSERT INTO commands (task_type, sequence_no, command_type, target_system, required_evidence_type, request_template_json, timeout_sec, is_active) VALUES
    ('MOVE',     1, 'move_to_point',  'movement', 'ARRIVED', '{"kind":"move_to_point","human_hazard_monitor":true}'::jsonb, 120, true),
    ('INBOUND',  1, 'move_to_point',  'movement', 'ARRIVED', '{"kind":"move_to_point","target":"inbound_scan","human_hazard_monitor":true}'::jsonb, 120, true),
    ...
    ('INBOUND',  7, 'move_to_point',  'movement', 'ARRIVED', '{"kind":"move_to_point","target":"home","human_hazard_monitor":true}'::jsonb, 120, true),
    ('OUTBOUND', 1, 'move_to_point',  'movement', 'ARRIVED', '{"kind":"move_to_point","target":"storage_scan","human_hazard_monitor":true}'::jsonb, 120, true),
    ...
    ('OUTBOUND', 7, 'move_to_point',  'movement', 'ARRIVED', '{"kind":"move_to_point","target":"home","human_hazard_monitor":true}'::jsonb, 120, true),
    ('CHARGE',   1, 'move_to_point',  'movement', 'ARRIVED', '{"kind":"move_to_point","target":"charge","human_hazard_monitor":true}'::jsonb, 120, true),
